...
<body>
    <div class="list-group list-group-flush">
        <nav class="navbar bg-body-tertiary fixed-top">
            ...
            <div id="cerrar"><a href="<?= site_url('logout') ?>" class="btn btn-danger" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill-dash" viewBox="0 0 16 16">
            ...
            <div class="container-fluid ">
                ...
                <div class="offcanvas offcanvas-start" data-bs-scroll="true" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div style="background-color:  rgb(21, 55, 87);">
                        <hr>
                    </div>
                    ...
                    <div class="offcanvas-body" id="offcanva" style="background-color:  rgb(21, 55, 87); ">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            <li class="nav-item">
                                <a class="nav-link active" style="color: #ffffff;" aria-current="page" href=" <?= base_url('index') ?>">
                            ...
                            <li class="nav-item dropdown" style="color: #153757;">
                                <a id="mod" class="nav-link" style="color: #ffffff;" data-bs-toggle="dropdown" href="">
                                    ...
                                    <h6 class="dropdown-toggle">Modulo de Activos</h6>
                                </a>
                            ...
                            <li class="nav-item dropdown" style="color: #153757;">
                                <a id="mod" class="nav-link" style="color: #ffffff;" href="" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                                        <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
                                    </svg>
                                    <h6 class="dropdown-toggle">Modulo de Responsables</h6>
                            ...
                            <li class="nav-item dropdown" style="color: #153757;">
                                <a id="mod" class="nav-link" href="" style="color: #ffffff;" data-bs-toggle="dropdown" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="18" fill="currentColor" class="bi bi-shuffle" viewBox="0 0 16 16">
                                    ...
                                    <h6 class="dropdown-toggle">Modulo de Movimientos</h6>
