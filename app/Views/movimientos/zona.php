                    ...
                    */
                    ...
                    <?php foreach ($zonas as $zona) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('editarzona/' . $zona['id_zona']) ?>" class="btn btn-info" type="button" data-bs-target="#modalUpdate" style="background-color: rgb(100, 145, 74);"><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-square text-light' viewBox='0 0 16 16'>
