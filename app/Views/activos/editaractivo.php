            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('actualizaractivo'); ?>" method="post" enctype="multipart/form-data">
                        <div class=" form-group">
                            <label for="nombre">Codigo</label>
                            <input type="text" class="form-control" readonly placeholder="Codigo" name="id" value="<?= $activo['codigo'] ?>">
                        </div>
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    <label for="nombre">Modelo</label>
                                    <input type="text" readonly  name="modelo" class="form-control" placeholder="Modelo" value="<?= $activo['modelo'] ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        <label>Serial</label>
                                        <input type="text" readonly  name="seria" class="form-control" placeholder="Serial" value="<?= $activo['serial'] ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        <label for="nombre">Condicion del Activo</label>
                                        <select name="condicion" readonly  class="form-control" onChange="selectGerenciasRespCons()">
                                            <option value="">Seleccione una opción...</option>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        <label for="proveedor">Proveedor</label>
                                        <input type="text"  readonly  name="proveedor" class="form-control" placeholder="Proveedor" value="<?= $activo['proveedor'] ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        <label for="proveedor">Nro. de Factura </label>
                                        <input type="text" readonly  name="factura" class="form-control" placeholder="Nro.Factura" value="<?= $activo['n_factura'] ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        <label for="proveedor">Costo</label>
                                        <input type="text" readonly  name="costo" class="form-control" placeholder="Costo" value="<?= $activo['costo'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        <label for="orden">Número de Orden</label>
                                        <input type="text" readonly  name="orden" class="form-control" placeholder="Número de Orden" value="<?= $activo['n_orden'] ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        <label for="periodo">Periodo de garantía desde</label>
                                        <input type="date"readonly  name="inicio" id="periodo" class="form-control" value="<?= $activo['garantia_inicio'] ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        <label for="periodo">Periodo de garantía hasta</label>
                                        <input type="date" readonly  name="fin" class="form-control" value="<?= $activo['garantia_fin'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="descripcion">Descripción</label>
                                <textarea name="descripcion" readonly  id="descripcion" cols="3" rows="3" class="form-control"></textarea  value="<?= $activo['descripcion'] ?>">
                        </div>
                </div>
            </div>
            <div class="modal-footer">
