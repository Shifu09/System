                        ...
                        <div class="modal-dialog">
                            <div class="modal-content" id="modal-content">
                                <div class="modal-header" style="background-color: #153757;">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">REGISTRO DE CONDICION DEL ACTIVO</h1>
...
<?php foreach ($condicion_act as $condicion) : ?>
    <tr>
        ...
        <td>
            <a href="<?= base_url('editarcondicion/' . $condicion['id_activo_condicion']) ?>" class="btn btn-info" style="background-color: rgb(100, 145, 74);" type="button"><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-square text-light' viewBox='0 0 16 16'>
