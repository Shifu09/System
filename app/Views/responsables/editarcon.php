        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('actualizarconn'); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre" class="form-control" value="<?= $condicion['nombre_condicion'] ?>" required spellcheck="false">
                        </div>
                </div>
                <div class="modal-footer">
                    <a type="button" class="btn btn-secondary" href="<?= site_url('condicion'); ?>">Cerrar</a>
