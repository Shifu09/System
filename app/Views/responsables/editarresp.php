    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" data-bs-target="#exampleModal" style="background-color: #153757;">
                <h1 class="modal-title fs-5" id="exampleModalLabel">CONSULTA DE RESPONSABLE</h1>
            </div>
                ...
                <form method="post" enctype="multipart/form-data">
                        ...
                        <div class=" row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre" readonly class="form-control" value="<?= $resp['nombre'] ?>">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for="nombre">Apellido</label>
                                    <input type="text" name="apellido" readonly class="form-control" value="<?= $resp['apellido'] ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="correo" readonly class="form-control" value="<?= $resp['correo'] ?>">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for="nombre">Telefono</label>
                                    <input type="text" name="telefono" readonly class="form-control" value="<?= $resp['telefono'] ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            <select name="condicion" class="form-control">
                                <option value="<?= $resp['condicion_resp'] ?>" readonly></option>
                                <?php
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="cargo" class="form-control" readonly required>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            <select name="gerencia" class="form-control" readonly onChange="selectGerenciasRespCons()" required>
                                <option value="">Seleccione una opción...</option>
                                <?php
